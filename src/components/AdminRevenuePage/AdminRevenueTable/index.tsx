            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead className="text-center min-w-[160px]">Chủ sở hữu</TableHead>
                        ...
                        transactions.map((t, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell className="text-center">
                                        <div className="flex flex-col items-center gap-1">
                                            <Badge variant="neutral">{t.owner?.fullName || "Chưa thiết lập"}</Badge>
                                            {t.owner?.email && (
                                                <span className="text-xs text-neutral-400 max-w-[150px] truncate" title={t.owner.email}>{t.owner.email}</span>
                                            )}
                                        </div>
                                    </TableCell>
