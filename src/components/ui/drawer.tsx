...
>(({ className, children, ...props }, ref) => (
	<DrawerPortal>
		...
		>
			...
			{children}
			<DrawerPrimitive.Close className="absolute right-3 top-3 opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-darkBackgroundV1 data-[state=open]:text-gray-500 bg-darkCardV1 rounded-full p-1">
