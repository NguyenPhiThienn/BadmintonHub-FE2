...
const SectionTitle = ({ title }: { title: string }) => (
  <h2 className="text-neutral-400 text-sm font-semibold uppercase mb-4 px-1">
    {title}
  </h2>
);
      ...
      <header className="sticky top-0 z-30 bg-darkBackgroundV1/60 backdrop-blur-xl border-b border-darkBorderV1">
        <div className="max-w-7xl mx-auto px-4 h-20 flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <h1 className="text-xl font-semibold tracking-tight text-white">Xác nhận đặt sân</h1>
              ...
              <div className="p-8 space-y-4">
                <div className="flex items-start justify-between">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <Badge variant="neutral" className="mb-2 bg-accent/20 text-accent border-accent/30 lowercase font-semibold">
                        Đang xử lý đặt sân
                      </Badge>
                      <h2 className="text-2xl font-semibold text-white mb-1">{venueName}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-6 bg-darkBackgroundV1/50 rounded-2xl border border-darkBorderV1/50">
                  <div className="space-y-1">
                    <span className="text-neutral-500 text-xs font-semibold uppercase ">Sân số</span>
                  ...
                  <div className="space-y-1">
                    <span className="text-neutral-500 text-xs font-semibold uppercase ">Thời gian</span>
                    <p className="text-white font-semibold flex items-center gap-2">
                  ...
                  <div className="space-y-1">
                    <span className="text-neutral-500 text-xs font-semibold uppercase ">Ngày thuê</span>
                    <p className="text-white font-semibold flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  >
                    ...
                    <span className="text-white font-semibold block mb-1">{method.name}</span>
                    <p className="text-neutral-500 text-sm uppercase font-semibold tracking-tighter">{method.desc}</p>
          ...
          <div className="lg:col-span-4 sticky top-28 space-y-4">
            <section className="bg-darkCardV1 border border-darkBorderV1 rounded-3xl p-8 shadow-2xl">
              ...
              <div className="space-y-4 mb-8">
                <span className="text-neutral-500 text-xs font-semibold uppercase  px-1">Mã giảm ưu đãi</span>
                ...
                {discount > 0 && (
                  <div className="flex items-center gap-2 text-emerald-400 text-sm font-semibold animate-in fade-in slide-in-from-right-2">
              ...
              <div className="space-y-4 pt-6 border-t border-darkBorderV1/50">
                <div className="flex justify-between items-center text-neutral-400">
                  ...
                  <span className="font-semibold text-white">{basePrice.toLocaleString()}đ</span>
                </div>
                {discount > 0 && (
                ...
                <div className="flex justify-between items-end pt-4 pb-2">
                  <div className="flex flex-col">
                    <span className="text-neutral-500 text-xs text-semibold uppercase ">Thành tiền</span>
                    <span className="text-neutral-400 text-sm italic">Đã bao gồm phí dịch vụ</span>
                  </div>
                  <div className="text-right text-accent">
                    <div className="text-3xl text-semibold tracking-tighter">
                ...
                <Button
                  className="w-full h-16 rounded-2xl text-lg text-semibold  bg-accent hover:bg-accent/90 shadow-xl shadow-accent/20 transition-all active:scale-[0.98] mt-4"
                ...
                <p className="text-center text-neutral-500 text-sm leading-relaxed pt-2">
