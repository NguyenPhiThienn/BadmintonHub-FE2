...
export const RoleBaoVeSoLechMayBienApTemplate = ({ job, device, categories, renderResults }: TemplateProps) => {
            ...
            <div className="overflow-hidden" style={{ border: BORDER, borderBottom: 0 }}>
              ...
              <div className="p-3 text-center bg-white">
                <div className="text-[14pt] font-semibold text-[#0070BF] uppercase leading-tight">
                  BIÊN BẢN THÍ NGHIỆM BẢO VỆ SO LỆCH MÁY BIẾN ÁP
                </div>
                <div className="text-[14pt] font-semibold text-[#C05711] italic leading-tight mt-0.5">
                  (Transformer differential protection Test Report)
                </div>
              </div>
            </div>
              ...
              <table className="w-full text-[13pt] border-collapse tech-info-table pointer-events-none" style={{ tableLayout: "fixed" }}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="px-2 py-0" style={{ width: "50%", borderLeft: 0 }}>
                      Ngày thí nghiệm <span className="italic text-[11pt]">(Test date)</span>: <span>{job.testDate ? format(new Date(job.testDate), "dd/MM/yyyy") : ""}</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="px-2 py-0 leading-tight" style={{ width: "25%" }}>
                      Tỉ số biến dòng điện <br /> <span className="italic text-[11pt]">(Current transformer ratios)</span>
                    </td>
                    <td className="p-0" style={{ width: "75%" }}>
                      <table className="w-full h-full !border-none border-collapse table-fixed">
                        <tbody>
                          <tr className="text-center">
                            <td className="p-1 leading-tight border-r border-black border-b border-b-black !border-t-0 !border-l-0" style={{ width: "33.33%" }}>
                              Phía {(device as any)?.hvWinding || "...."}kV <br /> <span className="italic text-[11pt]">(HV winding)</span>
                            </td>
                            <td className="p-1 leading-tight border-r border-black border-b border-b-black !border-t-0 !border-l-0" style={{ width: "33.33%" }}>
                              Phía {(device as any)?.mvWinding || "...."}kV <br /> <span className="italic text-[11pt]">(MV winding)</span>
                            </td>
                            <td className="p-1 leading-tight border-b border-b-black !border-t-0 !border-l-0 !border-r-0" style={{ width: "33.33%" }}>
                              Phía {(device as any)?.lvWinding || "...."}kV <br /> <span className="italic text-[11pt]">(LV winding)</span>
                            </td>
                          </tr>
                          <tr className="text-center h-8" style={{ border: "none" }}>
                            <td className="p-1 border-r border-black !border-b-0 !border-l-0">
                              {(device as any)?.ctRatio1 || ""}
                            </td>
                            <td className="p-1 border-r border-black !border-b-0 !border-l-0">
                              {(device as any)?.ctRatio2 || ""}
                            </td>
                            <td className="p-1 !border-b-0 !border-l-0 !border-r-0">
                              {(device as any)?.ctRatio3 || ""}
                            </td>
                          </tr>
                        </tbody>
                      </table>
