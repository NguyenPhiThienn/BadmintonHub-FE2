...
export const MayCatTemplate = ({ job, device, categories, renderResults }: TemplateProps) => {
  let sectionIndex = 1;
              ...
              <table className="w-full text-[13pt] border-collapse info-table tech-info-table" style={{ tableLayout: "fixed" }}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
                      Dòng định mức (A) <span className="italic text-[11pt]">(Rated current)</span>: <span>{(device as any)?.nominalCurrent || ""}</span>
                    </td>
                  </tr>
                  <tr>
                    <td colSpan={2} className="px-2 py-0">
                      Dòng cắt ngắn mạch định mức (kA) <span className="italic text-[11pt]">(Short circuit breaking current)</span>: <span>{(device as any)?.shortCircuitCurrent || ""}</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
