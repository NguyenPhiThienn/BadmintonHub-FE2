...
export const MayBienDienApKieuTuTemplate = ({ job, device, categories, renderResults }: TemplateProps) => {
  let sectionIndex = 1;
            ...
            <div className="overflow-hidden" style={{ border: BORDER, borderBottom: 0 }}>
              ...
              <div className="p-3 text-center bg-white">
                <div className="text-[14pt] font-bold text-[#0070BF] uppercase leading-tight">
                  BIÊN BẢN THÍ NGHIỆM MÁY BIẾN ĐIỆN ÁP KIỂU TỤ
                </div>
                <div className="text-[14pt] font-bold text-[#C05711] italic leading-tight mt-0.5">
                  (Capacitor voltage transformer test report)
                </div>
              </div>
            </div>
            ...
            <div>
              <table className="w-full text-[13pt] border-collapse info-table tech-info-table" style={{ tableLayout: "fixed" }}>
                <tbody>
                  ...
                  <tr>
                    <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
                      Cấp chính xác <span className="italic text-[11pt]">(Class)</span>: <span>{device?.accuracyClass || ""}</span>
                    </td>
                    <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
                      Công suất  <span className="italic text-[11pt]">(Burden)(VA)</span>: <span>{device?.capacity || ""}</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
                      Điện áp định mức <span className="italic text-[11pt]">(Rated voltage)(kV)</span>: <span>{device?.nominalVoltage || ""}</span>
                    </td>
                    <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
                      Điện dung <span className="italic text-[11pt]">(Capacitance)(pF)</span>: <span>{device?.capacitance || ""}</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
