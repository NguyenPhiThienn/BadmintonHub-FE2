...
export const ThietBiDemSetTemplate = ({ job, device, categories, renderResults }: TemplateProps) => {
  ...
  return (
    <div className="tbds-report flex flex-col gap-10 bg-white text-black print:gap-0">
      {/* PAGE 1 */}
      <div className="a4-page shadow-2xl print:shadow-none print:m-0 break-after-page relative" style={{ fontFamily: "'Tinos', 'Times New Roman', Times, serif" }}>
        <div className="p-1 flex-1 flex flex-col" style={{ border: BORDER }}>
          <div className="flex-1 flex flex-col box-border">
            ...
            <div>
              <table className="w-full text-[13pt] border-collapse info-table" style={{ tableLayout: "fixed" }}>
                <tbody>
                  <tr>
                        ...
                        <div className="flex-1">
                          {(() => {
                            ...
                            try {
                              ...
                              return (
                                <table className="tbds-serial-table w-full border-collapse" style={{ border: "none" }}>
                                  <tbody>
                                        ...
                                        <tr key={r} style={{ border: "none" }}>
                                          {Array.from({ length: maxCol }).map((_, cIdx) => {
                                            ...
                                            return (
                                              <td
                                                key={c}
                                                className="p-0 pr-2 text-[13pt] font-normal leading-tight"
      ...
      <style jsx>{`
        .tbds-report :global(.info-table tr:first-child td) {
          border-top: 0 !important;
        }

        .tbds-report :global(.info-table td) {
          border: ${BORDER} !important;
        }

        .tbds-report :global(.tbds-serial-table),
        .tbds-report :global(.tbds-serial-table td),
        .tbds-report :global(.tbds-serial-table th),
        .tbds-report :global(.tbds-serial-table tr) {
