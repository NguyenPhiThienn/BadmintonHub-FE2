...
export const CauChiTuRoiTemplate = ({ job, device, categories, renderResults }: TemplateProps) => {
  let sectionIndex = 1;
              ...
              <table className="w-full text-[13pt] border-collapse info-table tech-info-table" style={{ tableLayout: "fixed" }}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
                      Số lượng <span className="italic text-[11pt]">(Quantity)</span>: <span>{(device as any)?.quantity || ""} cái</span> <span className="italic text-[11pt]">(pieces)</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
                  ...
                  <tr>
                    ...
                    </td> <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
