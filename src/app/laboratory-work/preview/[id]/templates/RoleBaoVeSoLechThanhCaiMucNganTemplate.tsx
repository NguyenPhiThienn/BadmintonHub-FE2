...
export const RoleBaoVeSoLechThanhCaiMucNganTemplate = ({ job, device, categories, renderResults }: TemplateProps) => {
            ...
            <div>
              <table className="w-full text-[13pt] border-collapse tech-info-table pointer-events-none" style={{ tableLayout: "fixed" }}>
                <tbody>
                  ...
                  <tr>
                    <td colSpan={2} className="px-2 py-0">
                      Tỉ số biến dòng điện <span className="italic text-[11pt]">(Current transformation ratio)</span>: <span>{(device as any)?.ctRatio1}</span>
                    </td>
                  </tr>
                  <tr>
                    <td colSpan={2} className="px-2 py-0">
