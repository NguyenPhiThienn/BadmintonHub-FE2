...
export const DaoCachLyTemplate1P = ({ job, device, categories, renderResults }: TemplateProps) => {
  let sectionIndex = 1;
              ...
              <table className="w-full text-[13pt] border-collapse info-table tech-info-table" style={{ tableLayout: "fixed" }}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
                      Dòng điện định mức <span className="italic text-[11pt]">(Rated current)(A)</span>: <span>{device?.nominalCurrent || ""}</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="w-1/2 px-2 py-0" style={{ width: "50%" }}>
