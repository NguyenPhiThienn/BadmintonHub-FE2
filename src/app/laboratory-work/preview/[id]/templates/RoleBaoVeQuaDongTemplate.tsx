...
export const RoleBaoVeQuaDongTemplate = ({ job, device, categories, renderResults }: TemplateProps) => {
              ...
              <table className="w-full text-[13pt] border-collapse tech-info-table pointer-events-none" style={{ tableLayout: "fixed" }}>
                <tbody>
                  ...
                  <tr>
                      ...
                      <table className="w-full h-full !border-none border-collapse table-fixed">
                        <tbody>
                          <tr style={{ border: "none" }}>
                            <td className="px-2 py-0 leading-tight !border-none" style={{ width: "50%" }}>
                              Tỉ số biến điện áp <br /> <span className="italic text-[11pt]">(VT ratio)</span>
                            </td>
                            <td className="p-0 !border-r-0 !border-t-0 !border-b-0 !border-l-[1px] !border-l-black" style={{ width: "50%" }}>
                              <div className="flex flex-col h-full">
                                <div className="px-2 py-0.5 border-b border-black flex items-center h-1/2">
                                  <span className="italic text-[11pt] mr-1">Line VT ratio:</span>
                                  <span>{(device as any)?.lineVtRatio || ""}</span>
                                </div>
                                <div className="px-2 py-0.5 flex items-center h-1/2">
                                  <span className="italic text-[11pt] mr-1">Bus VT ratio:</span>
                                  <span>{(device as any)?.busVtRatio || ""}</span>
                                </div>
                              </div>
                            </td>
                          </tr>
                    ...
                    <td className="p-0" style={{ width: "50%", borderLeft: 0 }}>
                      <table className="w-full h-full !border-none border-collapse table-fixed">
                        <tbody>
                          <tr style={{ border: "none" }}>
                            <td className="px-2 py-0 leading-tight !border-none" style={{ width: "50%" }}>
                              Tỉ số biến dòng điện <br /> <span className="italic text-[11pt]">(CT ratio)</span>
                            </td>
                            <td className="p-0 !border-r-0 !border-t-0 !border-b-0 !border-l-[1px] !border-l-black" style={{ width: "50%" }}>
                              <div className="flex flex-col h-full justify-center">
                                <div className="px-2 py-0.5 border-b border-black flex items-center min-h-[1.5rem]">
                                  {(device as any)?.ctRatio1}
                                </div>
                                <div className="px-2 py-0.5 flex items-center min-h-[1.5rem]">
