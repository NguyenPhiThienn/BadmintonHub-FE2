...
const customerNames = [
  'Nguyen Van A', 'Tran Thi B', 'Le Minh C', 'Pham Hoang D', 'Hoang Thu E',
  'Vu Duc F', 'Dang Mai G', 'Bui Hai H', 'Cao Son I', 'Do Lan J',
  'Ngo Quang K', 'Trinh Thu L', 'Phan Tien M', 'Ly Thanh N', 'Truong Minh O',
  'Hong Ngoc P', 'Dinh Van Q', 'Bach Thi R', 'Coc Quang S', 'Nguyen Duc T',
];
...
async function seed() {
  ...
  for (const month of months) {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      const bookingsPerDay = isWeekend ? randomInt(8, 20) : randomInt(3, 8);
    ...
    console.log(`Month ${month}/2026 done`);
  }

  console.log(`\nSeed complete! Total bookings: ${totalBookings}, Total revenue: ${totalRevenue.toLocaleString()} VND`);
